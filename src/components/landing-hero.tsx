        ...
        <div className="mx-auto max-w-7xl">
          <AnimatePresence>
            <FadeUp key="title-main" duration={0.6}>
              <h1 className="bg-accent bg-clip-text py-2 text-5xl font-bold text-transparent sm:text-6xl md:text-7xl xl:text-8xl">{`Luckwin Subinaya`}</h1>
            </FadeUp>
            <FadeUp key="title-sub" duration={0.6} delay={0.2}>
              <span className="text-xl font-semibold text-pink-600 dark:text-pink-600 md:text-3xl">
