          ...
          {props.projects.map((proj) => (
            ...
            >
              <div className="flex gap-2">
                <span className="text-xl font-semibold text-accent transition-colors duration-300 sm:text-4xl md:text-5xl lg:hidden">
                  {proj.index + 1}.
                </span>
                <span
                  key={proj.title}
                  className="-underline-offset-1 text-xl font-semibold text-accent underline transition-colors duration-300 sm:text-4xl md:text-5xl lg:hidden"
                >
                  {proj.title}
                </span>
              </div>
