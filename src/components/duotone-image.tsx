...
const DuotoneImage: React.FC<DuotoneImageProps> = ({
  ...
  alt = "",
  lightColor = "#FFFFFF",
  // default to pure white / pure black for strict B&W duotone
  darkColor = "#000000",
  ...
  return (
    <div
      className={`overflow-hidden rounded-xl border-2 border-white bg-black dark:border-black ${className}`}
    >
      <Image
        {...props}
